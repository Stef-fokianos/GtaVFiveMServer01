...
declare function AddToItemset(itemset: number, p1: number): number;
...
declare function CashinventoryInitSessionIsFaulted(): number;

declare function CashinventoryInitSessionStatus(): [number, number, number];

declare function CashinventoryIsConnectionFaulted(): number;

declare function CashinventoryIsSessionReady(): number;

declare function CashinventoryTransactionAddItem(id: number, p2: number): [number, number];

declare function CashinventoryTransactionAddItemWithIngredients(id: number, p2: number, p4: number): [number, number, number];

declare function CashinventoryTransactionCheckout(id: number): number;

declare function CashinventoryTransactionCheckoutStatus(id: number, status: number): number;

declare function CashinventoryTransactionDelete(id: number): number;

declare function CashinventoryTransactionFireAndForgetItem(actionHash: string | number, p3: number): [number, number, number];

declare function CashinventoryTransactionGetAction(id: number): number;

declare function CashinventoryTransactionGetBasketIsValid(id: number): number;

declare function CashinventoryTransactionGetItemInfo(id: number, index: number, itemInfo: number): number;

declare function CashinventoryTransactionGetNumOfItems(id: number): number;

declare function CashinventoryTransactionResponseGetItemInfo(id: number, index: number, itemInfo: number): number;

declare function CashinventoryTransactionStart(_type: string | number, actionHash: string | number): [number, number];
...
declare function CheckOwnershipOfAnimScene(animScene: number): number;
...
declare function CloudHasRequestCompleted(p0: number): number;
...
declare function CreateIncident(dispatchService: number, x: number, y: number, z: number, numUnits: number, radius: number, p7: number, p8: number): [number, number];
...
declare function DatafileSelectActiveFile(p0: number, p1: number): number;
...
declare function DecorRemoveAll(entity: number): number;
...
declare function DecorSetString(entity: number, propertyName: string, value: string): number;

declare function DecorSetUint8(entity: number, propertyName: string, value: number): number;
...
declare function DoesScenarioExistInArea(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number): number;

declare function DoesScenarioGroupExist(scenarioGroup: string): number;

declare function DoesScenarioGroupExistHash(scenarioGroup: string | number): number;
...
declare function DoesScriptedCoverPointExistAtCoords(p0: number, p1: number, p2: number, p3: number): number;
...
declare function DoesTextLabelExist(label: string): number;
...
declare function EventManagerGetEvent(hash: string | number, eventData: number): number;

declare function EventManagerIsEventPending(hash: string | number): number;

declare function EventManagerPeekEvent(hash: string | number, eventData: number): number;
...
declare function ForcePedMotionState(ped: number, motionStateHash: string | number, p2: boolean, p3: number, p4: boolean): number;
...
declare function GetAmmoInClip(ped: number, weaponHash: string | number): [number, number];
...
declare function GetAnimalTuningBoolParam(animal: number, p1: number): number;
...
declare function GetClosestPed(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number, p10: number): number;
...
declare function GetCurrentPedWeapon(ped: number, p2: boolean, p3: number, p4: boolean): [number, number];
...
declare function GetGlobalBlockCanBeAccessed(index: number): number;
...
declare function GetGroundZFor_3dCoord(p0: number, p1: number, p2: number, p3: number, p4: number): number;
...
declare function GetProjectileNearPed(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number): number;

declare function GetProjectileNearPedCoords(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number): number;
...
declare function GiveWeaponToPed(ped: number): [number, number, number];
 ...
 * @param p12 :
 */
declare function GiveWeaponToPed_2(ped: number, weaponHash: string | number, ammoCount: number, equipNow: boolean, p4: boolean, weaponGroup: number, p6: boolean, p7: number, p8: number, p9: number, p10: boolean, p11: number, p12: boolean): number;
...
declare function HasEntityBeenDamagedByEntity(p0: number, p1: number, p2: number, p3: number): number;

declare function HasEntityClearLosToEntity(entity1: number, entity2: number, traceType: number): number;

declare function HasEntityClearLosToEntityInFront(p0: number, p1: number, p2: number): number;
...
declare function HasNamedPtfxAssetLoaded(fxNameHash: string | number): number;

declare function HasNetworkTimeStarted(): number;

declare function HasObjectBeenBroken(p0: number): number;

declare function HasPedGotWeapon(p0: number, p1: number, p2: number, p3: number): number;
...
declare function IsControlEnabled(padIndex: number, control: string | number): number;

declare function IsControlJustPressed(padIndex: number, control: string | number): number;

declare function IsControlJustReleased(padIndex: number, control: string | number): number;

declare function IsControlPressed(padIndex: number, control: string | number): number;

declare function IsControlReleased(padIndex: number, control: string | number): number;

declare function IsDamageTrackerActiveOnNetworkId(netID: number): number;

declare function IsDecalAlive(decal: number): number;

declare function IsDisabledControlJustPressed(padIndex: number, control: string | number): number;

declare function IsDisabledControlJustReleased(padIndex: number, control: string | number): number;

declare function IsDisabledControlPressed(padIndex: number, control: string | number): number;
...
declare function IsEntityDead(p0: number): number;

declare function IsEntityFocus(entity: number): number;

declare function IsEntityInAir(p0: number, p1: number): number;
...
declare function IsEntityInVolume(entity: number, volume: number, p2: boolean, p3: number): number;
...
declare function IsImapActive(imapHash: string | number): number;

declare function IsImapActive_2(imapHash: string | number): number;

declare function IsInItemset(itemset: number, p1: number): number;

declare function IsIncidentValid(incidentId: number): number;

declare function IsInputDisabled(padIndex: number): number;

declare function IsInteriorEntitySetActive(interior: number, entitySetName: string): number;

declare function IsInteriorReady(interior: number): number;

declare function IsInteriorRenderingDisabled(): number;

declare function IsInteriorScene(): number;

declare function IsItemsetValid(itemset: number): number;

/**
 * Same as GET_IS_LOADING_SCREEN_ACTIVE
 */
declare function IsLoadingScreenActive(): number;
...
declare function IsPedActiveInScenario(p0: number, p1: number): number;
...
declare function IsPedGroupMember(p0: number, p1: number, p2: number): number;
...
declare function IsPedInCover(p0: number, p1: number, p2: number): number;

declare function IsPedInCoverFacingLeft(ped: number): number;

declare function IsPedInCurrentConversation(p0: number, p1: number, p2: number): number;
...
declare function IsPedOnVehicle(p0: number, p1: number): number;

declare function IsPedOpeningADoor(ped: number): number;

declare function IsPedPerformingMeleeAction(p0: number, p1: number, p2: number): number;
...
declare function IsPlayerTargettingEntity(p0: number, p1: number, p2: number): number;
...
declare function IsProjectileTypeInRadius(p0: number, p1: number, p2: number, p3: number, p4: number, p5: boolean): number;
...
declare function IsScenarioGroupEnabledHash(scenarioGroup: string | number): number;
...
declare function IsScriptedConversationLoaded(p0: number): number;

declare function IsScriptedSpeechPlaying(p0: number): number;

declare function IsSeatWarpOnly(vehicle: number, seatIndex: number): number;
...
declare function IsSphereVisibleToAnotherMachine(p0: number, p1: number, p2: number, p3: number, p4: number): number;

declare function IsSphereVisibleToPlayer(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number): number;

declare function IsSrlLoaded(): number;

declare function IsStreamPlaying(p0: number): number;
...
declare function IsThreadActive(threadId: number, p1: boolean): number;
...
declare function IsValidInterior(interior: number): number;
...
declare function IsVehicleDriveable(p0: number, p1: number, p2: number): number;
...
declare function IsWaypointPlaybackGoingOnForPed(p0: number, p1: number): number;

declare function IsWaypointPlaybackGoingOnForVehicle(p0: number, p1: number): number;
...
declare function LogPostNotification(data: number): number;
...
declare function MinigameRequestSeatAtTable(data: number): number;
...
declare function MoneyDecrementCashBalance(amount: number): number;

declare function MoneyGetCashBalance(): number;

declare function MoneyIncrementCashBalance(amount: number, p1: number): number;
...
declare function N_0x049d2196d9d11184(): number;
...
declare function N_0x07ad9e43fd478527(p0: number, p1: number): number;
...
declare function N_0x11ea52cad1b55910(): number;
...
declare function N_0x16d3d49902f697bb(): number;
 ...
 */
declare function N_0x2238ec3ec631ab1f(): number;
...
declare function N_0x251241caec707106(): number;
...
declare function N_0x268ab8420a9e4ed7(): number;
...
declare function N_0x2701d01d5e18fc31(): number;
...
declare function N_0x43ab9d5a7d415478(): number;
...
declare function N_0x45d50415e4d885ff(): number;
...
declare function N_0x494a9874f17a7d50(p0: number): number;
 ...
 * @param p1 :
 */
declare function N_0x4ae1dff337a86fde(scriptIndex: number, p1: string): number;
...
declare function N_0x595f028698072dd9(p0: number): number;
...
declare function N_0x769e848c66e3c2bb(p0: number): [number, number, number];
...
declare function N_0x7c1c2062cfad06fe(unlockHash: string | number, data: number): void;
...
declare function N_0x7c981de05a7403a0(): number;
...
declare function N_0x80ddccb2f4a3eb57(ped: number, vehicle: number, p2: boolean, p3: boolean, p4: boolean): number;
...
declare function N_0x83f28ce49fbbffba(p0: number): number;
...
declare function N_0x84f0ba7462ff8d58(p1: number, p2: number, p3: number): [number, number];
...
declare function N_0x92a32ba29622763f(id: number, index: number, p2: number): number;
...
declare function N_0xab6a04cec428258b(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number, p10: number, p11: number, p12: number): number;
...
declare function N_0xc2c05defe85a0b64(): number;
...
declare function N_0xc71b50ae58d07369(p0: number): number;
...
declare function N_0xfb6eb8785f808551(player: number, p1: number, p2: boolean): number;
...
declare function NetworkAccessTunableBool(tunableContext: string | number, tunableName: string | number): number;

declare function NetworkAccessTunableInt(tunableContext: string | number, tunableName: string | number, value: number): number;
 ...
 */
declare function NetworkAreOnlineNotificationsShownInStoryMode(): number;
...
declare function NetworkDoesTunableExist(tunableContext: string | number, tunableName: string | number): number;

declare function NetworkEndTutorialSession(): void;

declare function NetworkGetClockTimeOverride(): [number, number, number, number];
...
declare function NetworkIsHandleValid(p0: number): number;
...
declare function NetworkIsPlayerAParticipantOnScript(p0: number, p2: number): [number, number];
...
declare function NetworkIsPlayerInSpectatorMode(player: number): number;
...
declare function NetworkSessionLeave(): number;
...
declare function NetworkTryAccessTunableBool(tunableContext: string | number, tunableName: string | number, defaultValue: boolean): number;
...
declare function PlaceObjectOnGroundProperly(p0: number, p1: number): number;
...
declare function PlayAnimalVocalization(pedHandle: number, p1: number, p2: number): void;
...
declare function PromptDoesAmbientGroupExist(hash: string | number): number;
...
declare function PromptGetUrgentPulsingEnabled(prompt: number): number;

declare function PromptHasHoldAutoFillMode(prompt: number): number;

declare function PromptHasHoldModeCompleted(prompt: number): number;

declare function PromptHasMashModeCompleted(prompt: number): number;

declare function PromptHasMashModeFailed(prompt: number): number;
...
declare function PromptHasStandardModeCompleted(prompt: number, p1: number): number;

declare function PromptIsActive(prompt: number): number;

declare function PromptIsEnabled(prompt: number): number;

declare function PromptIsHoldModeRunning(prompt: number): number;

declare function PromptIsJustPressed(prompt: number): number;

declare function PromptIsJustReleased(prompt: number): number;

declare function PromptIsPressed(prompt: number): number;

declare function PromptIsReleased(prompt: number): number;

declare function PromptIsValid(prompt: number): number;
...
declare function PromptWasBeatModePressedInTimeWindow(prompt: number): number;
...
declare function RequestScriptAudioBank(p0: number): number;
...
declare function SetControlNormal(padIndex: number, control: string | number, amount: number): number;
...
declare function SetVehicleOnGroundProperly(vehicle: number, p1: number): number;
 ...
 */
declare function ShouldUseMetricMeasurements_2(): number;

declare function ShouldUseMetricTemperature(): number;

declare function ShouldUseMetricWeight(): number;

declare function ShouldUse_24HourClock(): number;
...
declare function SpactionproxyGetNextPendingBuyAction(data: number): number;

declare function SpactionproxyGetNextPendingCraftingAction(data: number): number;

declare function SpactionproxyManagerIsFailed(): number;

declare function SpactionproxyManagerIsReady(): number;

declare function SpactionproxyProcessAction(p0: number, p1: boolean): number;

declare function SpactionproxyStartManager(): number;
...
declare function StartNetworkedParticleFxNonLoopedAtCoord(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number, p10: number): number;
 ...
 * @param value :
 */
declare function StatIdGetBool(): [number, number, any /* actually bool */];
 ...
 * @param date :
 */
declare function StatIdGetDate(): [number, number, number];
 ...
 * @param value :
 */
declare function StatIdGetFloat(): [number, number, number];
 ...
 * @param p1 :
 */
declare function StatIdGetInt(): [number, number, number];
 ...
 * @param statId :
 */
declare function StatIdIsValid(statId: number): number;
 ...
 * @param p2 :
 */
declare function StatIdSetBool(value: boolean, p2: boolean): [number, number];
 ...
 * @param p2 :
 */
declare function StatIdSetDate(p2: boolean): [number, number, number];
 ...
 * @param p2 :
 */
declare function StatIdSetFloat(value: number, p2: boolean): [number, number];
 ...
 * @param p2 :
 */
declare function StatIdSetGxtLabel(label: string, p2: boolean): [number, number];
 ...
 * @param p2 :
 */
declare function StatIdSetInt(value: number, p2: boolean): [number, number];
 ...
 * @param uuid :
 */
declare function TelemetryCreateUuid(uuid: number): number;
...
declare function UgcIsLanguageSupported(languageId: number): number;
...
declare function UnlockIsLootable(unlockHash: string | number): number;

declare function UnlockIsNew(unlockHash: string | number): number;

declare function UnlockIsUnlockFlagSet(unlockHash: string | number, flag: number): number;

declare function UnlockIsUnlocked(unlockHash: string | number): number;

declare function UnlockIsVisible(unlockHash: string | number): number;
